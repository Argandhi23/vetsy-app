...
class MyBookingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Scaffold ditambahkan di sini untuk mengatur background color
    return Scaffold(
      backgroundColor: Colors.grey[50], // WARNA BACKGROUND DISAMAKAN DENGAN PROFILE SCREEN
            ...
            return RefreshIndicator(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  // Pastikan locale 'id_ID' sudah diinisialisasi di root App/main.dart
