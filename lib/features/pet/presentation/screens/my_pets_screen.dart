...
class MyPetsScreen extends StatelessWidget {
  ...
  void _showPetFormModal(BuildContext context, {PetEntity? petToEdit}) {
    showModalBottomSheet(
      ...
      builder: (_) => Container(
        ...
        // Gunakan BlocProvider.value agar instance yang sama diteruskan ke Modal
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            ElevatedButton(
              ...
              onPressed: () {
                // Panggil deletePet dari context global
  ...
  Widget build(BuildContext context) {
    // [PERBAIKAN]: HAPUS BlocProvider PEMBUNGKUS.
    // Kita langsung pakai instance dari main.dart via context.read/watch.
    // Data sudah di-fetch otomatis di main.dart saat login, jadi tidak perlu dipanggil di sini lagi.
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (_) => BlocProvider.value(
                // Teruskan instance Cubit yang ada ke halaman detail
                value: context.read<MyPetsCubit>(),
